...
SECRET_KEY = 'django-insecure-__q+8hpgclq1v^_p@!i+ll&j=4k=%0of-_)h&@q#e*gjbc)52@'
...
# we should add static folder into path for css and imgages
STATICFILES_DIRS = (
